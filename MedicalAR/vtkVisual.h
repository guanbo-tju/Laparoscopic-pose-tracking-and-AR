...
{
public:
    VtkPose(pcl::PointCloud<pcl::PointXYZRGBA>::Ptr pts, std::string config, std::string lapaconfig);
    ...
    void combination();
    void setTheArgcs(string config);
...
//    double ratio = 4000.0;//深度相机
    ...
    std::shared_ptr<std::thread> showLapaCamera;
